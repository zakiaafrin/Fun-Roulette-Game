...
?>    
    ...
    <br/>
        <button class="cover-btn">Terms and Conditions</button> 
        ...
        <p>Please read these Terms and Conditions ("Terms", "Terms and Conditions") carefully before using the
            http://zjeme.techlaunch.io/Roulette-Game/ website (the "Service") operated by Fun Roulette Game ("us",
            "we", or "our").</p>
        ...
        <h2><button class="cover-btn">Accounts</button></h2>
        ...
        <h2><button class="cover-btn">Links To Other Web Sites</button></h2>

        <p>Our Service may contain links to third-party web sites or services that are not owned or controlled by Fun
            Roulette Game.</p>

        <p>Fun Roulette Game has no control over, and assumes no responsibility for, the content, privacy policies, or
            practices of any third party web sites or services. You further acknowledge and agree that Fun Roulette
            Game shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged
        ...
        <h2><button class="cover-btn">Termination</button></h2>
        ...
        <h2><button class="cover-btn">Governing Law</button></h2>

        <p>These Terms shall be governed and construed in accordance with the laws of Florida, United States, without
        ...
        <h2><button class="cover-btn">Changes</button></h2>
        ...
        <h2><button class="cover-btn">Contact Us</button></h2>

        <p>If you have any questions about these Terms and conditions, please contact us at 
        <a href="#"><strong><i>roulette@casino.com.</i></strong></a>    
        </p>
    </div>
    
    <button class="cover-btn" style="margin-left: 45%;"><a href="login.php">Back to Game</a></button> 
